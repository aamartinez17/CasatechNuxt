...
export const allProjects = [
  { 
    ...
    category: 'showcase', 
    tags: ['Tailwind CSS', 'Vue.js', 'Static Site'],
    description: 'A clean and modern website designed to help this Harrisonburg-based cleaning service build trust and generate new customer leads online.', 
  ...
  { 
    ...
    category: 'showcase', 
    tags: ['Tailwind CSS', 'Nuxt', 'Premium Branding'],
  ...
  { 
    ...
    category: 'showcase', 
    tags: ['Tailwind CSS', 'Vue.js', 'Lead Generation'],
  ...
  { 
    ...
    category: 'web-app', 
    tags: ['Bilingual App', 'Admin Panel', 'Database System'],
  ...
  { 
    ...
    category: 'showcase', 
    tags: ['Tailwind CSS', 'Vue.js', 'Conversion Focus'],
  ...
  { 
    ...
    category: 'showcase', 
    tags: ['Tailwind CSS', 'Nuxt', 'Local SEO'],
  ...
  { 
    ...
    category: 'web-app', 
    tags: ['Nuxt 3', 'Bilingual (EN/ES)', 'SSG Performance'],
    ...
    imageUrl: '/images/project-casatechllc.png', 
