<template>
  <article class="pt-32 pb-24 bg-bg-light min-h-screen">
    ...
    <header class="max-w-3xl mx-auto px-6 mb-12 text-center" v-motion-fade>
      <h1 class="text-4xl md:text-5xl font-heading font-extrabold text-heading mb-4">
        Privacy Policy
      </h1>
      <p class="text-secondary font-medium uppercase tracking-widest text-sm">
    ...
    <section class="max-w-3xl mx-auto px-6 prose prose-slate prose-lg">
      <div class="bg-white p-8 md:p-12 rounded-2xl shadow-soft border border-gray-100">
        ...
        <ul class="list-disc pl-6 space-y-2 text-body mb-8">
        ...
        <h2 class="text-2xl font-heading font-bold text-heading mt-10 mb-4">2. How We Use Your Information (Phone & SMS Clause)</h2>
        <div class="bg-bg-light p-6 rounded-xl border-l-4 border-cta mb-8">
          <p class="text-body font-medium leading-relaxed italic">
        ...
        <h2 class="text-2xl font-heading font-bold text-heading mt-10 mb-4">3. Absolute "Zero Data Sharing" Guarantee</h2>
        <p class="text-primary font-bold mb-6">
        ...
        <h2 class="text-2xl font-heading font-bold text-heading mt-10 mb-4">4. Data Security & Infrastructure</h2>
        <p class="text-body mb-8">
        ...
        <h2 class="text-2xl font-heading font-bold text-heading mt-10 mb-4">5. Your Rights & Data Control</h2>
        ...
        <footer class="pt-8 border-t border-gray-100 space-y-4">
          <h3 class="text-xl font-heading font-bold text-heading">Privacy Inquiries</h3>
          <div class="flex flex-col space-y-2">
            <a href="mailto:info@casatechllc.com" class="text-secondary font-bold hover:underline">info@casatechllc.com</a>
            <a href="tel:2038848244" class="text-primary font-bold hover:text-secondary transition-colors">(203) 884-8244</a>
          </div>
    ...
    <div class="max-w-3xl mx-auto px-6 mt-12 text-center">
      <NuxtLink to="/" class="text-secondary hover:text-primary font-bold transition-colors">
        ← Return to Homepage
      </NuxtLink>
    </div>
  </article>
